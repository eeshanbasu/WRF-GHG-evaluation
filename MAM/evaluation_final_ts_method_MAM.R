...
for(j in 1:length(sheets)){
  ...
  df_MAM_ts <- df_ts %>% 
    filter(df_ts$Time > as.POSIXct("2015-02-28 23:00:00", tz="UTC") & df_ts$Time < as.POSIXct("2015-06-01 00:00:00", tz="UTC"))  
...
write.xlsx2(finalDf, 
            file = "E:/Eeshan/evaluation/results/results_without_background_ts_MAM.xlsx", 
            sheetName="2015", 
            append=TRUE)
