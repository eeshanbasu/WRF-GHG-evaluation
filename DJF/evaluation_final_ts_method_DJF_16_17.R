...
for(j in 1:length(sheets)){
  ...
  df_DJF_ts <- df_ts %>% 
    filter(df_ts$Time > as.POSIXct("2015-11-30 23:00:00", tz="UTC") & df_ts$Time < as.POSIXct("2016-03-01 00:00:00", tz="UTC"))  
  ...
  df_DJF <- select(df_DJF, c(-FFDAS,-VULCAN))
...
write.xlsx2(finalDf, 
            file = "E:/Eeshan/evaluation/results/results_without_background_ts_DJF.xlsx", 
            sheetName="2016", 
            append=TRUE)
