...
for(j in 1:length(sheets)){
  ...
  df_DJF <- rbind(df_DJF_initial_1,df_DJF_initial_2,df_DJF_initial_3,
  ...
  df_DJF <- df_DJF[df_DJF$EDGAR_d02 >= 0, ] # drop negative values
  df_DJF <- df_DJF[df_DJF$ODIAC_d02 >= 0, ] # drop negative values
...
write.xlsx2(finalDf, 
            file = "E:/Eeshan/evaluation/results/results_DJF_d01_d02_d03.xlsx", 
            sheetName="Average", 
            append=TRUE)
