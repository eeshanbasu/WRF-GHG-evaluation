...
for(j in 1:length(sheets)){
  ...
  df_DJF <- df_DJF[df_DJF$EDGAR >= 100, ] # drop values less than 100
  # Drop NA values specifically for column 'A'
  df_DJF <- df_DJF[!is.na(df_DJF$Obs), ]
  df_DJF <- df_DJF[!is.na(df_DJF$ODIAC), ]
...
file_path <- "E:/Eeshan/evaluation/results/results_DJF_d01_d02.xlsx"
