...
for(j in 1:length(sheets)){
  ...
  df_DJF_ts <- df_ts %>% 
    filter(df_ts$Time > as.POSIXct("2016-11-30 23:00:00", tz="UTC") & df_ts$Time < as.POSIXct("2017-03-01 00:00:00", tz="UTC"))
  ...
  df_DJF <- select(df_DJF, c(-FFDAS,-VULCAN,-FFDAS_d02,-VULCAN_d02,-FFDAS_d03,-VULCAN_d03))
...
write.xlsx2(finalDf, 
            file = "E:/Eeshan/evaluation/results/results_without_background_ts_DJF_d01_d02_d03.xlsx", 
            sheetName="2017", 
            append=TRUE)
