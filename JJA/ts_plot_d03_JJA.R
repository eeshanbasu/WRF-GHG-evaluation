...
destination_plot_folder <- "E:/Eeshan/ts_text_files/plots/time_series_plots/d03/JJA/"
...
axis.POSIXct(1, at = seq(from = as.POSIXct(df$Time[1]), 
                         to = as.POSIXct(df$Time[2208]), length.out=7),
