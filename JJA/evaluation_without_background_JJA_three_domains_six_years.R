...
for(j in 1:length(sheets)){
  ...
  df_JJA_initial <- rbind(df_JJA_initial_1,df_JJA_initial_2,df_JJA_initial_3,df_JJA_initial_4,df_JJA_initial_5,df_JJA_initial_6)
  ...
  obs <- dplyr::pull(df_JJA, 2) #changing it to numeric
  EDGAR_d03 <- df_JJA[,11]
  EDGAR_d03 <- dplyr::pull(df_JJA,11)
...
write.xlsx2(finalDf, 
            file = "E:/Eeshan/evaluation/results/results_without_background_JJA_d01_d02_d03.xlsx", 
            sheetName="Average_6", 
            append=TRUE)
