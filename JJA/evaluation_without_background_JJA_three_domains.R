...
for(j in 1:length(sheets)){
  ...
  VULCAN_d02 <- dplyr::pull(df_JJA,10)
  ...
  FFDAS_d03 <- df_JJA[,12]
  FFDAS_d03 <- dplyr::pull(df_JJA,12)
  ...
  VULCAN_d03 <- dplyr::pull(df_JJA,14)
