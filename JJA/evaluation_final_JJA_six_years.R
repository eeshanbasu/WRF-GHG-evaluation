...
for(j in 1:length(sheets)){
  ...
  df_JJA <- rbind(df_JJA_initial_1,df_JJA_initial_2,df_JJA_initial_3,df_JJA_initial_4,df_JJA_initial_5,df_JJA_initial_6)
  
  df_JJA <- df_JJA[df_JJA$EDGAR >= 300, ] # drop values less than 100
  # Drop NA values specifically for column 'A'
  df_JJA <- df_JJA[!is.na(df_JJA$Obs), ]
  df_JJA <- df_JJA[!is.na(df_JJA$ODIAC), ]
...
file_path <- "E:/Eeshan/evaluation/results/results_JJA.xlsx"
