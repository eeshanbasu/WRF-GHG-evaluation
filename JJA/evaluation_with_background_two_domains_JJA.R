...
for(j in 1:length(sheets)){
  ...
  df_JJA <- df %>% 
    filter(df$Time > as.POSIXct("2017-05-31 23:00:00", tz="UTC") & df$Time < as.POSIXct("2017-08-01 00:00:00", tz="UTC"))
  
  df_JJA <- df_JJA[df_JJA$EDGAR >= 100, ] # drop values less than 100
...
write.xlsx2(finalDf, 
            file = "E:/Eeshan/evaluation/results/results_JJA_d01_d02.xlsx", 
            sheetName= "2017", 
            append = TRUE)
