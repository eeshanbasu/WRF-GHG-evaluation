...
for(j in 1:length(sheets)){
  ...
  df_JJA <- rbind(df_JJA_initial_1,df_JJA_initial_2,df_JJA_initial_3,
  ...
  df_JJA <- df_JJA[df_JJA$EDGAR_d02 >= 0, ] # drop negative values
  df_JJA <- df_JJA[df_JJA$ODIAC_d02 >= 0, ] # drop negative values
  df_JJA <- df_JJA[df_JJA$EDGAR_d03 >= 0, ] # drop negative values
  df_JJA <- df_JJA[df_JJA$ODIAC_d03 >= 0, ] # drop negative values
  # Drop NA values specifically for column 'A'
  df_JJA <- df_JJA[!is.na(df_JJA$Obs), ]
  df_JJA <-  df_JJA[ df_JJA$ODIAC_d03 >= 0, ] # drop negative values
  df_JJA <-  df_JJA[ df_JJA$EDGAR_d03 >= 300, ] # drop values less than 100
  ...
  obs <- dplyr::pull(df_JJA, 2) #changing it to numeric
  ODIAC_d03 <- df_JJA[,13]
  ODIAC_d03 <- dplyr::pull(df_JJA,13)
...
file_path <- "E:/Eeshan/evaluation/results/results_JJA_d01_d02_d03.xlsx"
