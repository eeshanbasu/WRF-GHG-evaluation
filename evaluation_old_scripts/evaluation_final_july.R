...
for(j in 1:length(sheets)){
  ...
  df_July <- df %>% 
    filter(df$Time > as.POSIXct("2015-07-01 00:00:00", tz="UTC") & df$Time < as.POSIXct("2015-08-01 00:00:00", tz="UTC"))
  ...
  statDf[i,1] <- paste(sheets[j],'_July')
  statDf[i,2] <- "EDGAR"
...
write.xlsx(finalDf, file = "E:/Eeshan/evaluation/results/results_july.xlsx", sheetName="2015", append=TRUE)