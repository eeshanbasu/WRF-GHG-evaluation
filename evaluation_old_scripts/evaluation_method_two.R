...
sheets <- getSheetNames("E:/Eeshan/evaluation/evaluation_method_two_paper_one.xlsx")
...
##### BU ##### 
# reading the data
df <- read_excel("E:/Eeshan/evaluation/evaluation_method_two_paper_one.xlsx",
                 sheet = "BU",
...
df_July$Obs[df_July$Obs > 300] <- NA #removing values above 300 ppm
...
write.xlsx(finalDf, 
           file = "E:/Eeshan/evaluation/results/results_method_two_July.xlsx", 
           sheetName="July", 
           append=TRUE)
