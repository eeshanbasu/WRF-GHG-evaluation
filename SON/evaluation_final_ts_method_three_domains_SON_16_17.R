...
for(j in 1:length(sheets)){
  ...
  df_SON_ts <- df_ts %>% 
    filter(df_ts$Time > as.POSIXct("2016-08-31 23:00:00", tz="UTC") & df_ts$Time < as.POSIXct("2016-12-01 00:00:00", tz="UTC"))
  ...
  df_SON <- select(df_SON, c(-FFDAS,-VULCAN,-FFDAS_d02,-VULCAN_d02,-FFDAS_d03,-VULCAN_d03))
...
write.xlsx2(finalDf, 
            file = "E:/Eeshan/evaluation/results/results_without_background_ts_SON_d01_d02_d03.xlsx", 
            sheetName="2016", 
            append=TRUE)
