...
for(j in 1:length(sheets)){
  ...
  df_SON <- rbind(df_SON_initial_1,df_SON_initial_2,df_SON_initial_3,df_SON_initial_4,df_SON_initial_5,df_SON_initial_6)
  
  df_SON <- df_SON[df_SON$EDGAR >= 300, ] # drop values less than 100
...
file_path <- "E:/Eeshan/evaluation/results/results_SON.xlsx"
