...
for(j in 1:length(sheets)){
  ...
  df_yearly <- df_yearly[df_yearly$EDGAR_d02 >= 0, ] # drop negative values
  df_yearly <- df_yearly[df_yearly$ODIAC_d02 >= 0, ] # drop negative values
...
file_path <- "E:/Eeshan/evaluation/results/results_without_background_yearly_d01_d02_d03.xlsx"
